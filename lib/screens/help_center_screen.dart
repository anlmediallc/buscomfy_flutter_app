            ...
            child: Row(
              children: [
                ...
                Expanded(child: Column(
                  ...
                  children: [
                    Text(t['title'], style: const TextStyle(color: Color(0xFF111827), fontSize: 16, fontWeight: FontWeight.w600)),
                    const SizedBox(height: 4),
                    Text(t['subtitle'], style: const TextStyle(color: Color(0xFF6B7280), fontSize: 12)),
                    const SizedBox(height: 4),
                    Text('${t['articles']} articles', style: const TextStyle(color: Color(0xFF9CA3AF), fontSize: 11)),
                  ],
                )),
        ...
        child: Column(
          ...
          children: [
            Row(children: [
              ...
              Text(topic['title'], style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
            ]),
